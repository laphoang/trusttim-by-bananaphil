...
| `Pitch-Deck-Content.md` | Slide-by-slide narration content (English, ~5 min, 9 slides) for the pitch deck — inquiry-first (leads with grounded Q&A breadth, safety is the payoff/twist later), a dedicated Technical Implementation slide alongside AI-Native Architecture (the rubric scores them separately), each slide tagged with the rubric criteria it targets, doctor as lead voice on pain/business/close. Includes a 4-min live-pitch trim and a Q&A-by-judge-archetype note. Grounded in the scoring rubric + Winning Playbook pitch arc. |
